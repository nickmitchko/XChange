...
public class KrakenTradeServiceRaw extends KrakenBaseService {
    ...
    public KrakenOrderResponse placeKrakenStopLossOrder(StopOrder stopOrder) throws IOException {
        KrakenType type = KrakenType.fromOrderType(stopOrder.getType());
        KrakenOrderBuilder krakenOrderBuilder =
                KrakenStandardOrder.getStopLossOrderBuilder(
